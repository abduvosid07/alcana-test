...
export default function App(){
  const[lang,setLang]=useState(()=>{if(typeof window==="undefined")return"uz";return localStorage.getItem("al_lang")||"uz";});
  ...
  const qs:any[] = dbSec
    ...
    : selectedSection==="umumiy" ? mapMlQs(QS_ALCANA)
    ...
    <div style={{minHeight:"100vh",background:"#f9fafb",fontFamily:"'Inter',system-ui,sans-serif"}}>
      ...
      <div style={{maxWidth:1000,margin:"0 auto",padding:"24px 16px 48px"}}>
        ...
        {mistakesRow && (()=>{
          ...
          let sourceLabel = "";
          if(skey==="alcana"||skey==="umumiy"){questionsSrc=mapMlQs(QS_ALCANA);sourceLabel=m.section_label||"Alcana";}
